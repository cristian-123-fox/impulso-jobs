...
import { CandidateProfileApi } from '@/features/candidate/data/candidate-profile.api';
import { CandidateResumeApi } from '@/features/candidate/data/candidate-resume.api';
import {
  CandidateEducation,
...
export class CandidateProfileFacade {
  ...
  /**
   * Carga sólo el perfil si aún no está en memoria — lo usa el layout para
   * pintar nombre/foto en el header sin disparar el `loadAll` completo.
   */
  ensureProfile(): void {

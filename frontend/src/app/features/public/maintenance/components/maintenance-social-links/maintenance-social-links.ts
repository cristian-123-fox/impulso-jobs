    ...
    <div class="flex flex-wrap gap-3">
      @for (social of socials(); track social.label) {
        <a
          ...
          class="flex h-[46px] w-[46px] items-center justify-center rounded-[10px] bg-white text-brand-strong shadow-card transition-all duration-200 hover:-translate-y-0.5 hover:bg-brand-700 hover:text-white hover:shadow-float"
        >

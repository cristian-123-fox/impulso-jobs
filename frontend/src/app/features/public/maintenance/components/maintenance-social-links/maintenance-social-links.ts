    ...
    <div class="flex flex-wrap gap-3">
      @for (social of socials(); track social.label) {
        <a
          ...
          class="flex h-[46px] w-[46px] items-center justify-center rounded-[10px] bg-white text-accent-blue shadow-card transition-all duration-200 hover:-translate-y-0.5 hover:shadow-float"
        >

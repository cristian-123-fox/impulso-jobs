...
@Component({
  ...
  template: `
    <section class="px-6 py-[90px] lg:px-[60px]">
      ...
      >
        <div>
          <p class="mb-[10px] text-[15px] font-semibold text-accent-blue">
            Cómo funciona
          </p>
          ...
          <div class="flex flex-col gap-4">
            @for (bullet of bullets(); track bullet) {
              <div class="flex items-center gap-3">
                <span
                  class="flex h-[26px] w-[26px] items-center justify-center rounded-full bg-accent-blue text-white"
                >
